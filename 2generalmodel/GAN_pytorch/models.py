...
class GeneratorResUnet(nn.Module):
    def __init__(self, in_channel=3, out_channel=3, filters=[64, 128, 256, 512]):
...
class Discriminator(nn.Module):
    def __init__(self, in_channels=3):
        ...
        self.model = nn.Sequential(
            *discriminator_block(in_channels * 2, 64, normalization=False), # 224->112
            *discriminator_block(64, 128), # 112->56
            *discriminator_block(128, 256), # 56->28
            *discriminator_block(256, 512), # 28->14
            nn.ZeroPad2d((1, 0, 1, 0)),
